...
Check [API Reference](/docs/react/api/interfaces/usequery)
...
Check [API Reference](/docs/react/api/interfaces/graphqlhoc)
...
Check [API Reference](/docs/react/api/interfaces/usepaginatedquery)
...
Check [API Reference](/docs/react/api/interfaces/usetransactionquery)
...
Check [API Reference](/docs/react/api/interfaces/uselazyquery)
...
Check [API Reference](/docs/react/api/interfaces/preparequery)
