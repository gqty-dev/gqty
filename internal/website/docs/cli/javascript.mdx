...
Although the focus of GQty is to be used in [TypeScript](https://www.typescriptlang.org/),
...
to be able to use a typed GQty.
...
To enable `JavaScript Output` you have to especify an extra `javascriptOutput` property in your [Configuration file](/docs/cli/config), with some extra considerations:
