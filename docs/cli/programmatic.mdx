...
**@pablosz/gqless-cli** has also a complete programmatic API, which allows you to generate the client with custom scripts.
...
```tsx
import { generate } from '@pablosz/gqless-cli';
...
```tsx
import { getRemoteSchema } from '@pablosz/gqless-cli';
